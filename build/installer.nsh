!macro customInstall
  ...
  nsExec::ExecToLog 'netsh advfirewall firewall delete rule name="E-Class Record Mobile Install (TCP)"'
  ...
  nsExec::ExecToLog 'netsh advfirewall firewall add rule name="E-Class Record Mobile Install (TCP)" dir=in action=allow program="$INSTDIR\${APP_EXECUTABLE_FILENAME}" enable=yes profile=any protocol=TCP localport=38474 remoteip=LocalSubnet'
!macroend
