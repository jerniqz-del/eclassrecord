...
const CHANNEL_POLICIES = Object.freeze({
  ...
  'dialog:export-pace-form': { maxBytes: 2 * 1024 * 1024, timeoutMs: 60_000 },
  'pace:official-form-html': { maxBytes: 256 * 1024, timeoutMs: 30_000 },
  'dialog:export-official-ecr': { maxBytes: 32 * 1024 * 1024, timeoutMs: 60_000 },
