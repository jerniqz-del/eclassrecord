...
assert(css.includes('.advisory-settings-grid'));
assert(css.includes('.btn-cancel'));
assert(css.includes('[data-remove-advisory-learner]'));
assert(css.includes('[data-delete-subject]'));
assert(css.includes('[data-reset-without]'));
