...
const gmrc = 'Good Manners and Right Conduct (GMRC)';
assert.strictEqual(context.determinePolicy('1', gmrc, '2026-2027'), 'DO15_DESCRIPTIVE');
assert.strictEqual(context.determinePolicy('2', gmrc, '2026-2027'), 'DO15_TRANSITION');
assert.strictEqual(context.determinePolicy('3', gmrc, '2026-2027'), 'DO15_TRANSITION');
assert.strictEqual(context.determinePolicy('4', gmrc, '2026-2027'), 'KEY_STAGE_2_TRIMESTER');
assert.strictEqual(context.determinePolicy('6', gmrc, '2026-2027'), 'KEY_STAGE_2_TRIMESTER');
assert.strictEqual(context.determineSubjectGroup('1', gmrc), 'CORE_20_50_30');
assert.strictEqual(context.determineSubjectGroup('3', gmrc), 'CORE_20_50_30');
assert.strictEqual(context.determineSubjectGroup('4', gmrc), 'KS2_TRIMESTER');
assert.strictEqual(context.determineSubjectGroup('6', gmrc), 'KS2_TRIMESTER');
assert.deepStrictEqual([...context.weightsFor('CORE_20_50_30')], [20, 50, 30]);
assert.deepStrictEqual([...context.weightsFor('KS2_TRIMESTER')], [20, 50, 30]);
assert.notStrictEqual(context.determineSubjectGroup('4', gmrc), 'SKILLS_20_60_20');
assert.strictEqual(context.transmute({ gradeLevel: '1', subject: gmrc, schoolYear: '2026-2027' }, 90), 'A');
assert.strictEqual(context.transmute({ gradeLevel: '1', subject: gmrc, schoolYear: '2026-2027' }, 80), 'B');
assert.strictEqual(context.transmute({ gradeLevel: '1', subject: gmrc, schoolYear: '2026-2027' }, 75), 'C');
assert.strictEqual(context.transmute({ gradeLevel: '1', subject: gmrc, schoolYear: '2026-2027' }, 65), 'D');
assert.strictEqual(context.transmute({ gradeLevel: '1', subject: gmrc, schoolYear: '2026-2027' }, 64), 'E');
