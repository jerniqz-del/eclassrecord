...
assert(experience.includes('picker-wheel-scene'));
assert(experience.includes('wheel.spinToItem'));
...
console.log('Teacher Tools launcher, usage counters, dedicated checklist, picker leaderboard, offline wheel, and additional games tests passed.');
